...
import intentcompany.tanrong.com.knowledgepointset.Permission.menu.Default;
import intentcompany.tanrong.com.knowledgepointset.Permission.menu.OPPO;
import intentcompany.tanrong.com.knowledgepointset.Permission.menu.VIVO;
...
public class PermissionUtils {
     ...
     * @return
     */
    public static boolean shouIdShowRequestPermissionRationale(Activity activity ,String ... permissions){
        for(String permission:permissions){
