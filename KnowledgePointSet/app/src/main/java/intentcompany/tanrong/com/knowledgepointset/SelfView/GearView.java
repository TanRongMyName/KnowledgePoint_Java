...
//        float c1Top = centerY-getRaidus(r1) * 2;
        ...
        int color2 = getResources().getColor(R.color.colorGear4);
        ...
        int color5 = getResources().getColor(R.color.colorGear1);
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawColor(this.getResources().getColor(R.color.colorGear2));
        if(isTranslation){
